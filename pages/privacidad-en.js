      ...
      <div className="py-12 bg-white mb-8 rounded-lg md:shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h1 className="mt-4 mb-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-800 sm:text-4xl">
              Políticas de Privacidad
            </h1>
            <p className="underline mb-4">
              Última actualización: Marzo 13, 2021
            </p>
          </div>
          <div>
            <p>
              ...
              derechos de privacidad y cómo le protege la ley.
            </p>
            <p>
              ...
              el uso de la información de acuerdo con esta Política de
              Privacidad.
            </p>
            <h2 className="font-bold mt-2">Interpretaciones y Definiciones</h2>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to SendMe.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to SendMe, accessible from{" "}
                  <a
                    href="https://sendmefiles.cloud/"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://sendmefiles.cloud/
                  </a>
                </p>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <a
                  href="https://sendmefiles.cloud/privacidad"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://sendmefiles.cloud/privacidad
                </a>
              </li>
            </ul>
          </div>
