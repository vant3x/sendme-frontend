...
const ProfileForm = ({user}) => {
    ...
    useEffect( async ()=> {
      const userInfo = await axiosClient.get(`/api/user/profile/${user ? user.id : null}`);
          ...
          <div className="mt-5 md:mt-0 md:col-span-2">
            <form action="#" method="POST">
              <div className="shadow overflow-hidden sm:rounded-md">
                ...
                <h3 className="text-3xl text-gray-800 text-center mb-4">Mi Cuenta</h3>

                <UserIconContainer className="bg-gray-100 border">
                    <div className="fas fa-user text-4xl text-gray-600"></div>
                </UserIconContainer>
                  <div className="grid grid-cols-6 gap-6 mt-4">
                    <div className="col-span-12 sm:col-span-3">
                      <label htmlFor="first_name" className="block text-sm font-medium text-gray-700">Nombre:</label>
                      <input type="text" name="first_name" defaultValue={userProfile ? userProfile.name : null} 
                    ...
                    <div className="col-span-12 sm:col-span-3">
                      ...
                      <input defaultValue={userProfile ? userProfile.lastname : null}  type="text" name="last_name" id="last_name" 
                    ...
                    <div className="col-span-12 sm:col-span-6">
                      ...
                      <input defaultValue={userProfile ? userProfile.email : null} 
                        placeholder="sendme@email.com"  
                       type="email" name="email_address" id="email_address" autoComplete="email"
                        className="shadow appereance-none  mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full py-2 px-3 shadow-sm sm:text-sm border border-gray-400 rounded-md"/>
                    </div>
                  ...
                  <div className="col-span-12 sm:col-span-6">
                     <label htmlFor="email_address" className="block text-sm font-medium text-gray-700">Usuario:</label>
                     <input defaultValue={userProfile ? userProfile.username : null} 
                       placeholder="sendme@email.com"  
                    ...
                    <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                     <a href="" className="text-red-400 underline hover:text-red-600">Cambiar Contraseña</a>
                    </div>
                ...
                <div className="px-4 py-3 bg-gray-50 text-right sm:px-6 flex justify-center">
                  <button type="submit" className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-red-500 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Actualizar Cambios  
                  </button>
                </div>
              </div>
